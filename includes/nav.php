                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="audit_samples"> Audit samples</a>
                            <a class="dropdown-item" href="#">Litepaper</a>
                        </div>
                    </li>
                    <!--<li class="nav-item">
                        <a class="nav-link" href="mission">Documents</a>
                    </li>-->
                    <li class="lh-55px">
                    <a href="contact" class="btn login-btn ml-50">Contact Us</a>
                    </li>
                </ul>
            </div>
        </div>
